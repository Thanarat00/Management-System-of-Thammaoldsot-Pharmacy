...
INNER JOIN tbl_customer AS c ON c.c_id=o.c_id
WHERE o.order_status=4 AND c.c_id = $c_id
    ...
    <tr>
     ...
     <td>
      ...
      <?php foreach ($rs_pp as $rs_pro) {?>
       <?php echo $num+=1;?> ) ชื่อสินค้า : <?php echo $rs_pro['p_name'];?> | จำนวน : <?php echo $rs_pro['p_c_qty'];?> | ราคาต่อชิ้น : <?php echo $rs_pro['p_price'];?> | ราคารวม : <?php echo $rs_pro['total'];?> <br>
      <?php }?>
      <hr>
     ...
     <td>
      ...
      <a href="user.php?order_id=<?php echo $rs_order['order_id'];?>&act=view" target="" class="btn btn-success btn-xs"><i class="nav-icon fas fa-clipboard-list"></i> เปิดดูรายการ</a>
